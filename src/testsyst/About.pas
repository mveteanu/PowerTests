...
type
  TAboutBox = class(TForm)
    ...
    procedure Label1MouseUp(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure CommentsDblClick(Sender: TObject);
  private
...
begin
  with TAboutBox.Create(Application) do
    try
      if InterfaceColors.Sounds then PlaySound('ABOUT', hInstance, snd_ASync or snd_Resource);
      ShowModal;
    finally
      Free;
    end;
...
procedure TAboutBox.CommentsDblClick(Sender: TObject);
begin
 Application.HelpCommand(HELP_CONTEXTPOPUP,1007);
end;
